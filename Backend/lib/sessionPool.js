...
var dbConnectionInfo = require('../lib/connection');
//Bug tweak
//Get a plain MySQL connection and create a session table (the express-mysql-sessi0on module in bugged and doesn't do it)
var dbCon = require('../lib/database');

let sql = "CREATE DATABASE IF NOT EXISTS NodeExpressSessionStorage";
console.log("sessonPool.js: sql message will be " +sql);
...
var options = {
    ...
    //createDatabaseTable:true not used because it was bugged which is why the code at the top is being used becasue this assumes The tabel already exists
};
